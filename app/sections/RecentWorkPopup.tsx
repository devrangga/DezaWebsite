...
const RecentWorkPopup: React.FC<RecentWorkPopupProps> = ({
  ...
  return (
    <div
      ...
      }  h-[70%] w-[75%] bg-gradient-to-t from-zinc-950 to-zinc-800 text-zinc-50 shadow-xl rounded-xl overflow-hidden p-4  fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-50`}
    >
